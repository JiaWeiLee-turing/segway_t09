  ...
  std::ostream & out)
{
  ...
  {
    out << "ros_set_forward_max_vel: ";
    rosidl_generator_traits::value_to_yaml(msg.ros_set_forward_max_vel, out);
    out << ", ";
  }

  // member: ros_set_backward_max_vel
  {
    out << "ros_set_backward_max_vel: ";
    rosidl_generator_traits::value_to_yaml(msg.ros_set_backward_max_vel, out);
    out << ", ";
  }

  // member: ros_set_angular_max_vel
  {
    out << "ros_set_angular_max_vel: ";
    rosidl_generator_traits::value_to_yaml(msg.ros_set_angular_max_vel, out);
  }
  out << "}";
  ...
  std::ostream & out)
{
  ...
  {
    out << "chassis_set_max_vel_result: ";
    rosidl_generator_traits::value_to_yaml(msg.chassis_set_max_vel_result, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)

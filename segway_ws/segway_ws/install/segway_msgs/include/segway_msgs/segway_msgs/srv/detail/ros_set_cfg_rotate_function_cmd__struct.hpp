...
struct RosSetCfgRotateFunctionCmd_Request_
{
  ...
  using _cfg_in_situ_rotation_function_type =
    bool;
  _cfg_in_situ_rotation_function_type cfg_in_situ_rotation_function;

  // setters for named parameter idiom
  Type & set__cfg_in_situ_rotation_function(
    const bool & _arg)
  {
    this->cfg_in_situ_rotation_function = _arg;
    return *this;
  }
  ...
  {
    if (this->cfg_in_situ_rotation_function != other.cfg_in_situ_rotation_function) {
      return false;
    }
    return true;
  }
...
struct RosSetCfgRotateFunctionCmd_Response_
{
  ...
  // field types and members
  using _cfg_in_situ_rotation_result_type =
    uint8_t;
  _cfg_in_situ_rotation_result_type cfg_in_situ_rotation_result;

  // setters for named parameter idiom
  Type & set__cfg_in_situ_rotation_result(
    const uint8_t & _arg)
  {
    this->cfg_in_situ_rotation_result = _arg;
    return *this;
  }
  ...
  {
    if (this->cfg_in_situ_rotation_result != other.cfg_in_situ_rotation_result) {
      return false;
    }
    return true;
  }

...
struct RosStopChassisRotateCmd_Request_
{
  ...
  using _ros_stop_chassis_rotate_cmd_type =
    bool;
  _ros_stop_chassis_rotate_cmd_type ros_stop_chassis_rotate_cmd;

  // setters for named parameter idiom
  Type & set__ros_stop_chassis_rotate_cmd(
    const bool & _arg)
  {
    this->ros_stop_chassis_rotate_cmd = _arg;
    return *this;
  }
  ...
  {
    if (this->ros_stop_chassis_rotate_cmd != other.ros_stop_chassis_rotate_cmd) {
      return false;
    }
    return true;
  }

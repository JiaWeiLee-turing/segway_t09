...
segway_msgs__srv__RosGetVelMaxFeedbackCmd_Request__are_equal(const segway_msgs__srv__RosGetVelMaxFeedbackCmd_Request * lhs, const segway_msgs__srv__RosGetVelMaxFeedbackCmd_Request * rhs)
{
  ...
  // ros_get_vel_max_fb_cmd
  if (lhs->ros_get_vel_max_fb_cmd != rhs->ros_get_vel_max_fb_cmd) {
    return false;
  }
  return true;
}
  ...
  segway_msgs__srv__RosGetVelMaxFeedbackCmd_Request * output)
{
  ...
  // ros_get_vel_max_fb_cmd
  output->ros_get_vel_max_fb_cmd = input->ros_get_vel_max_fb_cmd;
  return true;
}
...
segway_msgs__srv__RosGetVelMaxFeedbackCmd_Response__are_equal(const segway_msgs__srv__RosGetVelMaxFeedbackCmd_Response * lhs, const segway_msgs__srv__RosGetVelMaxFeedbackCmd_Response * rhs)
{
  ...
  // forward_max_vel_fb
  if (lhs->forward_max_vel_fb != rhs->forward_max_vel_fb) {
    return false;
  }
  // backward_max_vel_fb
  if (lhs->backward_max_vel_fb != rhs->backward_max_vel_fb) {
    return false;
  }
  // angular_max_vel_fb
  if (lhs->angular_max_vel_fb != rhs->angular_max_vel_fb) {
    return false;
  }
  return true;
}
  ...
  segway_msgs__srv__RosGetVelMaxFeedbackCmd_Response * output)
{
  ...
  // forward_max_vel_fb
  output->forward_max_vel_fb = input->forward_max_vel_fb;
  // backward_max_vel_fb
  output->backward_max_vel_fb = input->backward_max_vel_fb;
  // angular_max_vel_fb
  output->angular_max_vel_fb = input->angular_max_vel_fb;
  return true;
}

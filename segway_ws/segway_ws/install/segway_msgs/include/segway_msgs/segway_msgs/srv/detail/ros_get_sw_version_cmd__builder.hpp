...
class Init_RosGetSwVersionCmd_Request_ros_get_sw_version_cmd
{
public:
  Init_RosGetSwVersionCmd_Request_ros_get_sw_version_cmd()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::segway_msgs::srv::RosGetSwVersionCmd_Request ros_get_sw_version_cmd(::segway_msgs::srv::RosGetSwVersionCmd_Request::_ros_get_sw_version_cmd_type arg)
  {
    msg_.ros_get_sw_version_cmd = std::move(arg);
...
{
  return segway_msgs::srv::builder::Init_RosGetSwVersionCmd_Request_ros_get_sw_version_cmd();
}
...
class Init_RosGetSwVersionCmd_Response_host_pantch_version
{
public:
  explicit Init_RosGetSwVersionCmd_Response_host_pantch_version(::segway_msgs::srv::RosGetSwVersionCmd_Response & msg)
  : msg_(msg)
  {}
  Init_RosGetSwVersionCmd_Response_central_version host_pantch_version(::segway_msgs::srv::RosGetSwVersionCmd_Response::_host_pantch_version_type arg)
  {
    msg_.host_pantch_version = std::move(arg);
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_RosGetSwVersionCmd_Response_host_pantch_version host_version(::segway_msgs::srv::RosGetSwVersionCmd_Response::_host_version_type arg)
  {
    msg_.host_version = std::move(arg);
    return Init_RosGetSwVersionCmd_Response_host_pantch_version(msg_);
  }

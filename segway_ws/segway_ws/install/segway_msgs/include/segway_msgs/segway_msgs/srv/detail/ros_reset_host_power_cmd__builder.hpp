...
class Init_RosResetHostPowerCmd_Request_reset_interval_time
{
public:
  Init_RosResetHostPowerCmd_Request_reset_interval_time()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::segway_msgs::srv::RosResetHostPowerCmd_Request reset_interval_time(::segway_msgs::srv::RosResetHostPowerCmd_Request::_reset_interval_time_type arg)
  {
    msg_.reset_interval_time = std::move(arg);
...
{
  return segway_msgs::srv::builder::Init_RosResetHostPowerCmd_Request_reset_interval_time();
}

...
struct RosGetRotateFunctionCfgCmd_Response_
{
  ...
  // field types and members
  using _cfg_in_situ_rotation_cmd_type =
    uint8_t;
  _cfg_in_situ_rotation_cmd_type cfg_in_situ_rotation_cmd;

  // setters for named parameter idiom
  Type & set__cfg_in_situ_rotation_cmd(
    const uint8_t & _arg)
  {
    this->cfg_in_situ_rotation_cmd = _arg;
    return *this;
  }
  ...
  {
    if (this->cfg_in_situ_rotation_cmd != other.cfg_in_situ_rotation_cmd) {
      return false;
    }
    return true;
  }

  ...
  std::ostream & out)
{
  ...
  {
    out << "chassis_send_event_id: ";
    rosidl_generator_traits::value_to_yaml(msg.chassis_send_event_id, out);
  }
  out << "}";
  ...
  std::ostream & out)
{
  ...
  {
    out << "ros_is_received: ";
    rosidl_generator_traits::value_to_yaml(msg.ros_is_received, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)

  ...
  std::ostream & out)
{
  ...
  {
    out << "ros_set_chassis_buzzer_cmd: ";
    rosidl_generator_traits::value_to_yaml(msg.ros_set_chassis_buzzer_cmd, out);
  }
  out << "}";
  ...
  std::ostream & out)
{
  ...
  {
    out << "set_buzzer_result: ";
    rosidl_generator_traits::value_to_yaml(msg.set_buzzer_result, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)

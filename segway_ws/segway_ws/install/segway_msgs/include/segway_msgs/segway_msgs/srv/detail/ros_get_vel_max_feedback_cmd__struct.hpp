...
struct RosGetVelMaxFeedbackCmd_Request_
{
  ...
  using _ros_get_vel_max_fb_cmd_type =
    bool;
  _ros_get_vel_max_fb_cmd_type ros_get_vel_max_fb_cmd;

  // setters for named parameter idiom
  Type & set__ros_get_vel_max_fb_cmd(
    const bool & _arg)
  {
    this->ros_get_vel_max_fb_cmd = _arg;
    return *this;
  }
  ...
  {
    if (this->ros_get_vel_max_fb_cmd != other.ros_get_vel_max_fb_cmd) {
      return false;
    }
    return true;
  }
...
struct RosGetVelMaxFeedbackCmd_Response_
{
  ...
  // field types and members
  using _forward_max_vel_fb_type =
    uint16_t;
  _forward_max_vel_fb_type forward_max_vel_fb;
  using _backward_max_vel_fb_type =
    uint16_t;
  _backward_max_vel_fb_type backward_max_vel_fb;
  using _angular_max_vel_fb_type =
    uint16_t;
  _angular_max_vel_fb_type angular_max_vel_fb;

  // setters for named parameter idiom
  Type & set__forward_max_vel_fb(
    const uint16_t & _arg)
  {
    this->forward_max_vel_fb = _arg;
    return *this;
  }
  Type & set__backward_max_vel_fb(
    const uint16_t & _arg)
  {
    this->backward_max_vel_fb = _arg;
    return *this;
  }
  Type & set__angular_max_vel_fb(
    const uint16_t & _arg)
  {
    this->angular_max_vel_fb = _arg;
    return *this;
  }
  ...
  {
    if (this->forward_max_vel_fb != other.forward_max_vel_fb) {
      return false;
    }
    if (this->backward_max_vel_fb != other.backward_max_vel_fb) {
      return false;
    }
    if (this->angular_max_vel_fb != other.angular_max_vel_fb) {
      return false;
    }
    return true;
  }

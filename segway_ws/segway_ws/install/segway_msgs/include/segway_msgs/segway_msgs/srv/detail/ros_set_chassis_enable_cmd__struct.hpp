...
struct RosSetChassisEnableCmd_Request_
{
  ...
  using _ros_set_chassis_enable_cmd_type =
    bool;
  _ros_set_chassis_enable_cmd_type ros_set_chassis_enable_cmd;

  // setters for named parameter idiom
  Type & set__ros_set_chassis_enable_cmd(
    const bool & _arg)
  {
    this->ros_set_chassis_enable_cmd = _arg;
    return *this;
  }
  ...
  {
    if (this->ros_set_chassis_enable_cmd != other.ros_set_chassis_enable_cmd) {
      return false;
    }
    return true;
  }
...
struct RosSetChassisEnableCmd_Response_
{
  ...
  // field types and members
  using _chassis_set_chassis_enable_result_type =
    uint8_t;
  _chassis_set_chassis_enable_result_type chassis_set_chassis_enable_result;

  // setters for named parameter idiom
  Type & set__chassis_set_chassis_enable_result(
    const uint8_t & _arg)
  {
    this->chassis_set_chassis_enable_result = _arg;
    return *this;
  }
  ...
  {
    if (this->chassis_set_chassis_enable_result != other.chassis_set_chassis_enable_result) {
      return false;
    }
    return true;
  }

...
struct RosSetVelMaxCmd_Request_
{
  ...
  using _ros_set_forward_max_vel_type =
    double;
  _ros_set_forward_max_vel_type ros_set_forward_max_vel;
  using _ros_set_backward_max_vel_type =
    double;
  _ros_set_backward_max_vel_type ros_set_backward_max_vel;
  using _ros_set_angular_max_vel_type =
    double;
  _ros_set_angular_max_vel_type ros_set_angular_max_vel;

  // setters for named parameter idiom
  Type & set__ros_set_forward_max_vel(
    const double & _arg)
  {
    this->ros_set_forward_max_vel = _arg;
    return *this;
  }
  Type & set__ros_set_backward_max_vel(
    const double & _arg)
  {
    this->ros_set_backward_max_vel = _arg;
    return *this;
  }
  Type & set__ros_set_angular_max_vel(
    const double & _arg)
  {
    this->ros_set_angular_max_vel = _arg;
    return *this;
  }
  ...
  {
    if (this->ros_set_forward_max_vel != other.ros_set_forward_max_vel) {
      return false;
    }
    if (this->ros_set_backward_max_vel != other.ros_set_backward_max_vel) {
      return false;
    }
    if (this->ros_set_angular_max_vel != other.ros_set_angular_max_vel) {
      return false;
    }
    return true;
  }
...
struct RosSetVelMaxCmd_Response_
{
  ...
  // field types and members
  using _chassis_set_max_vel_result_type =
    uint8_t;
  _chassis_set_max_vel_result_type chassis_set_max_vel_result;

  // setters for named parameter idiom
  Type & set__chassis_set_max_vel_result(
    const uint8_t & _arg)
  {
    this->chassis_set_max_vel_result = _arg;
    return *this;
  }
  ...
  {
    if (this->chassis_set_max_vel_result != other.chassis_set_max_vel_result) {
      return false;
    }
    return true;
  }

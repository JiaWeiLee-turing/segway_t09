  ...
  std::ostream & out)
{
  ...
  {
    out << "clear_chassis_error_code_cmd: ";
    rosidl_generator_traits::value_to_yaml(msg.clear_chassis_error_code_cmd, out);
  }
  out << "}";
  ...
  std::ostream & out)
{
  ...
  {
    out << "clear_chassis_error_code_result: ";
    rosidl_generator_traits::value_to_yaml(msg.clear_chassis_error_code_result, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)

  ...
  std::ostream & out)
{
  ...
  {
    out << "ros_get_sw_version_cmd: ";
    rosidl_generator_traits::value_to_yaml(msg.ros_get_sw_version_cmd, out);
  }
  out << "}";
  ...
  std::ostream & out)
{
  ...
  {
    out << "host_pantch_version: ";
    rosidl_generator_traits::value_to_yaml(msg.host_pantch_version, out);
    out << ", ";
  }

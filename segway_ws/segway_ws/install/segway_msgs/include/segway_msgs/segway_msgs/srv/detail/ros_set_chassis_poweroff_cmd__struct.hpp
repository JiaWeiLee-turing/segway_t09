...
struct RosSetChassisPoweroffCmd_Request_
{
  ...
  using _ros_set_chassis_poweroff_cmd_type =
    bool;
  _ros_set_chassis_poweroff_cmd_type ros_set_chassis_poweroff_cmd;

  // setters for named parameter idiom
  Type & set__ros_set_chassis_poweroff_cmd(
    const bool & _arg)
  {
    this->ros_set_chassis_poweroff_cmd = _arg;
    return *this;
  }
  ...
  {
    if (this->ros_set_chassis_poweroff_cmd != other.ros_set_chassis_poweroff_cmd) {
      return false;
    }
    return true;
  }
...
struct RosSetChassisPoweroffCmd_Response_
{
  ...
  // field types and members
  using _chassis_set_poweroff_result_type =
    uint8_t;
  _chassis_set_poweroff_result_type chassis_set_poweroff_result;

  // setters for named parameter idiom
  Type & set__chassis_set_poweroff_result(
    const uint8_t & _arg)
  {
    this->chassis_set_poweroff_result = _arg;
    return *this;
  }
  ...
  {
    if (this->chassis_set_poweroff_result != other.chassis_set_poweroff_result) {
      return false;
    }
    return true;
  }

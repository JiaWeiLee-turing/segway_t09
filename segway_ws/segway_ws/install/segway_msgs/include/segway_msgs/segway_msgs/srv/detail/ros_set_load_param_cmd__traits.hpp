  ...
  std::ostream & out)
{
  ...
  {
    out << "ros_set_load_param: ";
    rosidl_generator_traits::value_to_yaml(msg.ros_set_load_param, out);
  }
  out << "}";
  ...
  std::ostream & out)
{
  ...
  {
    out << "chassis_set_load_param_result: ";
    rosidl_generator_traits::value_to_yaml(msg.chassis_set_load_param_result, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)

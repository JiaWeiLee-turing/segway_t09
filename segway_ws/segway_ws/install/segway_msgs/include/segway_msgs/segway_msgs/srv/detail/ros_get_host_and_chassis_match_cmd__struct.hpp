...
struct RosGetHostAndChassisMatchCmd_Response_
{
  ...
  // field types and members
  using _is_matched_with_firmware_type =
    uint8_t;
  _is_matched_with_firmware_type is_matched_with_firmware;

  // setters for named parameter idiom
  Type & set__is_matched_with_firmware(
    const uint8_t & _arg)
  {
    this->is_matched_with_firmware = _arg;
    return *this;
  }
  ...
  {
    if (this->is_matched_with_firmware != other.is_matched_with_firmware) {
      return false;
    }
    return true;
  }

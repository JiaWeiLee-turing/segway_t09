  ...
  std::ostream & out)
{
  ...
  {
    out << "ros_get_vel_max_fb_cmd: ";
    rosidl_generator_traits::value_to_yaml(msg.ros_get_vel_max_fb_cmd, out);
  }
  out << "}";
  ...
  std::ostream & out)
{
  ...
  {
    out << "forward_max_vel_fb: ";
    rosidl_generator_traits::value_to_yaml(msg.forward_max_vel_fb, out);
    out << ", ";
  }

  // member: backward_max_vel_fb
  {
    out << "backward_max_vel_fb: ";
    rosidl_generator_traits::value_to_yaml(msg.backward_max_vel_fb, out);
    out << ", ";
  }

  // member: angular_max_vel_fb
  {
    out << "angular_max_vel_fb: ";
    rosidl_generator_traits::value_to_yaml(msg.angular_max_vel_fb, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)

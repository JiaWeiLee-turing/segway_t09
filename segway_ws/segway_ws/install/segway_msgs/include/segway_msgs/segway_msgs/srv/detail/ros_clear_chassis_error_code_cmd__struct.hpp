...
struct RosClearChassisErrorCodeCmd_Request_
{
  ...
  using _clear_chassis_error_code_cmd_type =
    bool;
  _clear_chassis_error_code_cmd_type clear_chassis_error_code_cmd;

  // setters for named parameter idiom
  Type & set__clear_chassis_error_code_cmd(
    const bool & _arg)
  {
    this->clear_chassis_error_code_cmd = _arg;
    return *this;
  }
  ...
  {
    if (this->clear_chassis_error_code_cmd != other.clear_chassis_error_code_cmd) {
      return false;
    }
    return true;
  }
...
struct RosClearChassisErrorCodeCmd_Response_
{
  ...
  // field types and members
  using _clear_chassis_error_code_result_type =
    uint8_t;
  _clear_chassis_error_code_result_type clear_chassis_error_code_result;

  // setters for named parameter idiom
  Type & set__clear_chassis_error_code_result(
    const uint8_t & _arg)
  {
    this->clear_chassis_error_code_result = _arg;
    return *this;
  }
  ...
  {
    if (this->clear_chassis_error_code_result != other.clear_chassis_error_code_result) {
      return false;
    }
    return true;
  }

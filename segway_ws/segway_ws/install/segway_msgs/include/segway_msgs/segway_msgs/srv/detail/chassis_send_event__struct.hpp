...
struct ChassisSendEvent_Request_
{
  ...
  using _chassis_send_event_id_type =
    int16_t;
  _chassis_send_event_id_type chassis_send_event_id;

  // setters for named parameter idiom
  Type & set__chassis_send_event_id(
    const int16_t & _arg)
  {
    this->chassis_send_event_id = _arg;
    return *this;
  }
  ...
  {
    if (this->chassis_send_event_id != other.chassis_send_event_id) {
      return false;
    }
    return true;
  }
...
struct ChassisSendEvent_Response_
{
  ...
  // field types and members
  using _ros_is_received_type =
    bool;
  _ros_is_received_type ros_is_received;

  // setters for named parameter idiom
  Type & set__ros_is_received(
    const bool & _arg)
  {
    this->ros_is_received = _arg;
    return *this;
  }
  ...
  {
    if (this->ros_is_received != other.ros_is_received) {
      return false;
    }
    return true;
  }

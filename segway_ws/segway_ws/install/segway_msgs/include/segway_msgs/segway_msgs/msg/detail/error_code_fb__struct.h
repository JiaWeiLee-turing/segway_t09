...
#ifndef SEGWAY_MSGS__MSG__DETAIL__ERROR_CODE_FB__STRUCT_H_
#define SEGWAY_MSGS__MSG__DETAIL__ERROR_CODE_FB__STRUCT_H_
...
#endif  // SEGWAY_MSGS__MSG__DETAIL__ERROR_CODE_FB__STRUCT_H_

...
#ifndef SEGWAY_MSGS__MSG__DETAIL__SPEED_FB__FUNCTIONS_H_
#define SEGWAY_MSGS__MSG__DETAIL__SPEED_FB__FUNCTIONS_H_
...
#endif  // SEGWAY_MSGS__MSG__DETAIL__SPEED_FB__FUNCTIONS_H_

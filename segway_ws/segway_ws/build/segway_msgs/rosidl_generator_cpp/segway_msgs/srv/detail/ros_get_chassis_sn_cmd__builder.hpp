...
class Init_RosGetChassisSnCmd_Request_ros_get_chassis_sn
{
public:
  Init_RosGetChassisSnCmd_Request_ros_get_chassis_sn()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::segway_msgs::srv::RosGetChassisSnCmd_Request ros_get_chassis_sn(::segway_msgs::srv::RosGetChassisSnCmd_Request::_ros_get_chassis_sn_type arg)
  {
    msg_.ros_get_chassis_sn = std::move(arg);
...
{
  return segway_msgs::srv::builder::Init_RosGetChassisSnCmd_Request_ros_get_chassis_sn();
}

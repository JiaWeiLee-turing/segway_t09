...
struct RosGetSwVersionCmd_Request_
{
  ...
  using _ros_get_sw_version_cmd_type =
    bool;
  _ros_get_sw_version_cmd_type ros_get_sw_version_cmd;

  // setters for named parameter idiom
  Type & set__ros_get_sw_version_cmd(
    const bool & _arg)
  {
    this->ros_get_sw_version_cmd = _arg;
    return *this;
  }
  ...
  {
    if (this->ros_get_sw_version_cmd != other.ros_get_sw_version_cmd) {
      return false;
    }
    return true;
  }
...
struct RosGetSwVersionCmd_Response_
{
  ...
  using _host_pantch_version_type =
    uint16_t;
  _host_pantch_version_type host_pantch_version;
  ...
  Type & set__host_pantch_version(
    const uint16_t & _arg)
  {
    this->host_pantch_version = _arg;
    return *this;
  }
  ...
  bool operator==(const RosGetSwVersionCmd_Response_ & other) const
  {
    ...
    if (this->host_pantch_version != other.host_pantch_version) {
      return false;
    }

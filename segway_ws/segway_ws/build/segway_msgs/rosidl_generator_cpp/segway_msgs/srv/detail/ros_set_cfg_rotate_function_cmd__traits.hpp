  ...
  std::ostream & out)
{
  ...
  {
    out << "cfg_in_situ_rotation_function: ";
    rosidl_generator_traits::value_to_yaml(msg.cfg_in_situ_rotation_function, out);
  }
  out << "}";
  ...
  std::ostream & out)
{
  ...
  {
    out << "cfg_in_situ_rotation_result: ";
    rosidl_generator_traits::value_to_yaml(msg.cfg_in_situ_rotation_result, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)

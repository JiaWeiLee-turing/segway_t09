...
struct RosGetChassisRotateSwitchCmd_Request_
{
  ...
  using _ros_get_chassis_rotate_cmd_type =
    bool;
  _ros_get_chassis_rotate_cmd_type ros_get_chassis_rotate_cmd;

  // setters for named parameter idiom
  Type & set__ros_get_chassis_rotate_cmd(
    const bool & _arg)
  {
    this->ros_get_chassis_rotate_cmd = _arg;
    return *this;
  }
  ...
  {
    if (this->ros_get_chassis_rotate_cmd != other.ros_get_chassis_rotate_cmd) {
      return false;
    }
    return true;
  }
...
struct RosGetChassisRotateSwitchCmd_Response_
{
  ...
  // field types and members
  using _chassis_rotate_state_type =
    uint8_t;
  _chassis_rotate_state_type chassis_rotate_state;

  // setters for named parameter idiom
  Type & set__chassis_rotate_state(
    const uint8_t & _arg)
  {
    this->chassis_rotate_state = _arg;
    return *this;
  }
  ...
  {
    if (this->chassis_rotate_state != other.chassis_rotate_state) {
      return false;
    }
    return true;
  }

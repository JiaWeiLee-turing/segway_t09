...
struct RosGetLoadParamCmd_Request_
{
  ...
  using _ros_get_load_param_type =
    bool;
  _ros_get_load_param_type ros_get_load_param;

  // setters for named parameter idiom
  Type & set__ros_get_load_param(
    const bool & _arg)
  {
    this->ros_get_load_param = _arg;
    return *this;
  }
  ...
  {
    if (this->ros_get_load_param != other.ros_get_load_param) {
      return false;
    }
    return true;
  }
...
struct RosGetLoadParamCmd_Response_
{
  ...
  // field types and members
  using _get_load_param_type =
    int16_t;
  _get_load_param_type get_load_param;

  // setters for named parameter idiom
  Type & set__get_load_param(
    const int16_t & _arg)
  {
    this->get_load_param = _arg;
    return *this;
  }
  ...
  {
    if (this->get_load_param != other.get_load_param) {
      return false;
    }
    return true;
  }

...
class Init_RosStopChassisRotateCmd_Request_ros_stop_chassis_rotate_cmd
{
public:
  Init_RosStopChassisRotateCmd_Request_ros_stop_chassis_rotate_cmd()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::segway_msgs::srv::RosStopChassisRotateCmd_Request ros_stop_chassis_rotate_cmd(::segway_msgs::srv::RosStopChassisRotateCmd_Request::_ros_stop_chassis_rotate_cmd_type arg)
  {
    msg_.ros_stop_chassis_rotate_cmd = std::move(arg);
...
{
  return segway_msgs::srv::builder::Init_RosStopChassisRotateCmd_Request_ros_stop_chassis_rotate_cmd();
}

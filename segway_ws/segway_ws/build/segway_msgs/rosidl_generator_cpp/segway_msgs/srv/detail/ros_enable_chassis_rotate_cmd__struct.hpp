...
struct RosEnableChassisRotateCmd_Request_
{
  ...
  using _ros_enable_chassis_rotate_cmd_type =
    bool;
  _ros_enable_chassis_rotate_cmd_type ros_enable_chassis_rotate_cmd;

  // setters for named parameter idiom
  Type & set__ros_enable_chassis_rotate_cmd(
    const bool & _arg)
  {
    this->ros_enable_chassis_rotate_cmd = _arg;
    return *this;
  }
  ...
  {
    if (this->ros_enable_chassis_rotate_cmd != other.ros_enable_chassis_rotate_cmd) {
      return false;
    }
    return true;
  }
...
struct RosEnableChassisRotateCmd_Response_
{
  ...
  // field types and members
  using _chassis_enable_rotate_result_type =
    int16_t;
  _chassis_enable_rotate_result_type chassis_enable_rotate_result;

  // setters for named parameter idiom
  Type & set__chassis_enable_rotate_result(
    const int16_t & _arg)
  {
    this->chassis_enable_rotate_result = _arg;
    return *this;
  }
  ...
  {
    if (this->chassis_enable_rotate_result != other.chassis_enable_rotate_result) {
      return false;
    }
    return true;
  }

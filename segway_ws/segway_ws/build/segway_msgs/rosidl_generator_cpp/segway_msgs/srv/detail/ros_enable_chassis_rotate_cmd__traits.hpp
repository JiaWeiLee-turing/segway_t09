  ...
  std::ostream & out)
{
  ...
  {
    out << "ros_enable_chassis_rotate_cmd: ";
    rosidl_generator_traits::value_to_yaml(msg.ros_enable_chassis_rotate_cmd, out);
  }
  out << "}";
  ...
  std::ostream & out)
{
  ...
  {
    out << "chassis_enable_rotate_result: ";
    rosidl_generator_traits::value_to_yaml(msg.chassis_enable_rotate_result, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)

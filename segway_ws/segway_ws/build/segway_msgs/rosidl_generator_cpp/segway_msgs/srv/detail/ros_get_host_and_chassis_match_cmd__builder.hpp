...
class Init_RosGetHostAndChassisMatchCmd_Response_is_matched_with_firmware
{
public:
  Init_RosGetHostAndChassisMatchCmd_Response_is_matched_with_firmware()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::segway_msgs::srv::RosGetHostAndChassisMatchCmd_Response is_matched_with_firmware(::segway_msgs::srv::RosGetHostAndChassisMatchCmd_Response::_is_matched_with_firmware_type arg)
  {
    msg_.is_matched_with_firmware = std::move(arg);
...
{
  return segway_msgs::srv::builder::Init_RosGetHostAndChassisMatchCmd_Response_is_matched_with_firmware();
}

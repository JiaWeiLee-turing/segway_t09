...
struct RosSetLoadParamCmd_Request_
{
  ...
  using _ros_set_load_param_type =
    int16_t;
  _ros_set_load_param_type ros_set_load_param;

  // setters for named parameter idiom
  Type & set__ros_set_load_param(
    const int16_t & _arg)
  {
    this->ros_set_load_param = _arg;
    return *this;
  }
  ...
  {
    if (this->ros_set_load_param != other.ros_set_load_param) {
      return false;
    }
    return true;
  }
...
struct RosSetLoadParamCmd_Response_
{
  ...
  // field types and members
  using _chassis_set_load_param_result_type =
    uint8_t;
  _chassis_set_load_param_result_type chassis_set_load_param_result;

  // setters for named parameter idiom
  Type & set__chassis_set_load_param_result(
    const uint8_t & _arg)
  {
    this->chassis_set_load_param_result = _arg;
    return *this;
  }
  ...
  {
    if (this->chassis_set_load_param_result != other.chassis_set_load_param_result) {
      return false;
    }
    return true;
  }

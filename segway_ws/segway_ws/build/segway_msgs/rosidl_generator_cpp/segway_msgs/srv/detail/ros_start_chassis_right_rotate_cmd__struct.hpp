...
struct RosStartChassisRightRotateCmd_Request_
{
  ...
  using _ros_start_chassis_right_rotate_cmd_type =
    double;
  _ros_start_chassis_right_rotate_cmd_type ros_start_chassis_right_rotate_cmd;

  // setters for named parameter idiom
  Type & set__ros_start_chassis_right_rotate_cmd(
    const double & _arg)
  {
    this->ros_start_chassis_right_rotate_cmd = _arg;
    return *this;
  }
  ...
  {
    if (this->ros_start_chassis_right_rotate_cmd != other.ros_start_chassis_right_rotate_cmd) {
      return false;
    }
    return true;
  }
...
struct RosStartChassisRightRotateCmd_Response_
{
  ...
  // field types and members
  using _chassis_right_rotate_result_type =
    int16_t;
  _chassis_right_rotate_result_type chassis_right_rotate_result;

  // setters for named parameter idiom
  Type & set__chassis_right_rotate_result(
    const int16_t & _arg)
  {
    this->chassis_right_rotate_result = _arg;
    return *this;
  }
  ...
  {
    if (this->chassis_right_rotate_result != other.chassis_right_rotate_result) {
      return false;
    }
    return true;
  }

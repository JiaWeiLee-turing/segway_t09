...
class Init_RosGetRotateFunctionCfgCmd_Response_cfg_in_situ_rotation_cmd
{
public:
  Init_RosGetRotateFunctionCfgCmd_Response_cfg_in_situ_rotation_cmd()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::segway_msgs::srv::RosGetRotateFunctionCfgCmd_Response cfg_in_situ_rotation_cmd(::segway_msgs::srv::RosGetRotateFunctionCfgCmd_Response::_cfg_in_situ_rotation_cmd_type arg)
  {
    msg_.cfg_in_situ_rotation_cmd = std::move(arg);
...
{
  return segway_msgs::srv::builder::Init_RosGetRotateFunctionCfgCmd_Response_cfg_in_situ_rotation_cmd();
}

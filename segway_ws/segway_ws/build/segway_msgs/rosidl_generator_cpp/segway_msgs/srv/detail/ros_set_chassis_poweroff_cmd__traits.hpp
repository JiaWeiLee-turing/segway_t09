  ...
  std::ostream & out)
{
  ...
  {
    out << "ros_set_chassis_poweroff_cmd: ";
    rosidl_generator_traits::value_to_yaml(msg.ros_set_chassis_poweroff_cmd, out);
  }
  out << "}";
  ...
  std::ostream & out)
{
  ...
  {
    out << "chassis_set_poweroff_result: ";
    rosidl_generator_traits::value_to_yaml(msg.chassis_set_poweroff_result, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)

...
#include "segway_msgs/msg/detail/speed_fb__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = segway_msgs::msg::SpeedFb;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const segway_msgs::msg::SpeedFb *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<segway_msgs::msg::SpeedFb *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SpeedFb__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const segway_msgs::msg::SpeedFb *>(
...
static size_t _SpeedFb__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SpeedFb(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SpeedFb__callbacks = {
  "segway_msgs::msg",
  "SpeedFb",
...
static rosidl_message_type_support_t _SpeedFb__handle = {
...
{
  return &segway_msgs::msg::typesupport_fastrtps_cpp::_SpeedFb__handle;
}

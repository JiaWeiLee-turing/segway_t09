...
#include "segway_msgs/msg/detail/ticks_fb__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = segway_msgs::msg::TicksFb;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const segway_msgs::msg::TicksFb *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<segway_msgs::msg::TicksFb *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TicksFb__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const segway_msgs::msg::TicksFb *>(
...
static size_t _TicksFb__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TicksFb(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TicksFb__callbacks = {
  "segway_msgs::msg",
  "TicksFb",
...
static rosidl_message_type_support_t _TicksFb__handle = {
...
{
  return &segway_msgs::msg::typesupport_fastrtps_cpp::_TicksFb__handle;
}

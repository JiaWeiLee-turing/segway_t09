...
#include "segway_msgs/msg/detail/bms_fb__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = segway_msgs::msg::BmsFb;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const segway_msgs::msg::BmsFb *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<segway_msgs::msg::BmsFb *>(
    untyped_ros_message);
...
static size_t _BmsFb__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BmsFb(full_bounded, is_plain, 0);
...
{
  return &segway_msgs::msg::typesupport_fastrtps_cpp::_BmsFb__handle;
}
